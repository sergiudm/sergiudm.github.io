...
description: "Double Descent is a phenomenon in which the test error of a model first decreases, then increases, and then decreases again as the model complexity increases."
slug: "double-descent"
